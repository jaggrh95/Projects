        ...
        static void Main(string[] args)
        {
            ...
            while (again == 1)
            {
                ...
                while (again == 0)
                {
                    ...
                    Console.Write(score + " " + opschuif[teller] + " " + locatie);
                    ...
                    if (enable != 2 && (locatie <= opschuif[teller] || locatie >= opschuif[teller] + diffic))
                    {
                        ...
                        do
                        {
                            Console.WriteLine("U bent gecrasht! uw score is " + score + " op een difficulty van " + diff);
                            Console.Write("Wilt u nog eens? 1 = Ja , 2 = Nee");
                            diff = Console.ReadLine();
                            if (diff == "" )
                            {
